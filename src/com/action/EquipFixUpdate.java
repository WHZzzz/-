...
public class EquipFixUpdate extends ActionSupport{
	//下面是Action内用于封装用户请求参数的属性
		private String fix_id;
		private EquipFixBean cnbean;
		public String getFix_id() {
			return fix_id;
		}

		public void setFix_id(String studentID) {
			fix_id = studentID;
		}

		public EquipFixBean getCnbean() {
			return cnbean;
		}

		public void setCnbean(EquipFixBean cnbean) {
			this.cnbean = cnbean;
		}
