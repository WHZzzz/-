      ...
      <td height="500" align="center" valign="top"><table width="1350" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="1142.3" align="justify" valign="top" ><table width="1142.3" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
             <td height="470" align="justify" valign="top"  background="Images/p3.jpg"><form name="form1" method="post" action="EquipFixUpdateSave.action" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="33%" height="30" align="right">&nbsp;</td>
                    <td width="67%"><input name="fix_id" type="text" class="noshow" id="fix_id" value="<s:property value='cnbean.fix_id'/>"></td>
                  </tr>
                  <tr>
                 ...
                 <tr>
                  ...
                  <tr>
                    ...
                    <td><input name="fix_type" type="text" class="text2" id="fix_type" value="<s:property value='cnbean.fix_type'/>"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>设备规格：</td>
                    <td><input name="fix_model" type="text" class="text2" id="fix_model" value="<s:property value='cnbean.fix_model'/>"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>设备数量：</td>
                    <td><input name="fix_num" type="text" class="text2" id="fix_num" value="<s:property value='cnbean.fix_num'/>"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>修理日期：</td>
                    <td><input name="fix_date" type="text" class="text2" id="fix_date" value="<s:property value='cnbean.fix_date'/>"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>修理厂家：</td>
                    <td><input name="fix_fac" type="text" class="text2" id="fix_fac" value="<s:property value='cnbean.fix_fac'/>"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>修理单价：</td>
                    <td><input name="fix_cost" type="text" class="text2" id="fix_cost" value="<s:property value='cnbean.fix_cost'/>"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>负责人：</td>
                    <td><input name="fix_lia" type="text" class="text2" id="fix_lia" value="<s:property value='cnbean.fix_lia'/>"></td>
                  </tr>
