...
function mycheck(){
   ...
   if(isNull(form1.Equipment_ID.value)){
   alert("请输入设备编号！");
   return false;
   }
      ...
      <td height="500" align="center" valign="top"><table width="1350" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="1142.3" align="justify" valign="top" ><table width="1142.3" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="30"  style="padding-left:25px;">修改设备</td>
            </tr>
            <tr>
             <td height="470" align="justify" valign="top"  background="Images/p3.jpg"><form name="form1" method="post" action="EquipmentUpdateSave.action" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="33%" height="30" align="right">&nbsp;</td>
                    <td width="67%"><input name="Equipment_ID" type="text" class="noshow" id="Equipment_ID" value="<s:property value='cnbean.Equipment_ID'/>"></td>
                  </tr>
                  <tr>
                  ...
                  <td height="30" align="right"><span style="color:red;">*</span>设备名：</td>
                    <td><input name="Equipment_Name" type="text" class="text2" id="Equipment_Name" value="<s:property value='cnbean.Equipment_Name'/>"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>设备类型：</td>
                    <td><input name="Equipment_Type" type="text" class="text2" id="Equipment_Type" value="<s:property value='cnbean.Equipment_Type'/>"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>数量：</td>
                    <td><input name="Equipment_Number" type="text" class="text2" id="Equipment_Number" value="<s:property value='cnbean.Equipment_Number'/>"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>设备规格：</td>
                    <td><input name="Equipment_Model" type="text" class="text2" id="Equipment_Model" value="<s:property value='cnbean.Equipment_Model'/>"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>生产厂家：</td>
                    <td><input name="Equipment_Fac" type="text" class="text2" id="Equipment_Fac" value="<s:property value='cnbean.Equipment_Fac'/>"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>设备单价：</td>
                    <td><input name="Equipment_Price" type="text" class="text2" id="Equipment_Price" value="<s:property value='cnbean.Equipment_Price'/>"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>生产日期：</td>
                    <td><input name="Equipment_Bdate" type="text" class="text2" id="Equipment_Bdate" value="<s:property value='cnbean.Equipment_Bdate'/>"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>经办人：</td>
                    <td><input name="Equipment_Operator" type="text" class="text2" id="Equipment_Operator" value="<s:property value='cnbean.Equipment_Operator'/>"></td>
                  </tr>
